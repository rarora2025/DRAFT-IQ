...
import { Activity, Mail, Lock, Loader2, AlertCircle, Chrome } from 'lucide-react'
        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8 space-y-6 backdrop-blur-sm">
          ...
          >
            {googleLoading ? (
              ...
              <>
                ...
                <span className="font-display font-bold tracking-wide">Continue with Google</span>
              </>
            )}
          </Button>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#020420] px-2 text-zinc-500 font-medium">Or continue with email</span>
            </div>
          </div>
