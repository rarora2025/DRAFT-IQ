                      ...
                      >
                          <div className="flex items-center justify-between gap-2 sm:gap-3">
                            <div className="flex items-center gap-2 sm:gap-5 min-w-0">
                              <div className={`w-8 h-8 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center border shrink-0 transition-transform group-hover:scale-110 ${pos.side === 'long' ? 'bg-orange-500/10 border-orange-500/20 text-orange-400' : 'bg-blue-500/10 border-blue-500/20 text-blue-400'}`}>
                                {pos.side === 'long' ? <ArrowUpCircle className="w-4 h-4 sm:w-6 sm:h-6" /> : <ArrowDownCircle className="w-4 h-4 sm:w-6 sm:h-6" />}
                              </div>
                              <div className="flex flex-col min-w-0">
                                <span className="text-[10px] sm:text-base font-black text-white truncate uppercase tracking-tight leading-tight">{pos.market_title || 'NBA Market'}</span>
                                  <div className="flex items-center gap-1 overflow-hidden mt-0.5">
                                    <span className="text-[7px] sm:text-[10px] font-black text-muted-foreground uppercase tracking-[0.1em] whitespace-nowrap">${pos.size.toFixed(2)}</span>
                                    <div className="w-0.5 h-0.5 rounded-full bg-white/10 shrink-0" />
                                    <span className="text-[7px] sm:text-[10px] text-muted-foreground font-mono whitespace-nowrap">
                            ...
                            <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
                              <button 
                                ...
                                className="p-1.5 sm:p-2 hover:bg-white/5 rounded-lg transition-colors text-zinc-600 hover:text-primary"
                                title="Share trade"
                              >
                                <Share2 className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                              </button>
                              <div className="text-right">
                                <span className={`font-mono font-black text-[12px] sm:text-xl whitespace-nowrap ${isProfit ? 'text-emerald-400' : 'text-red-400'}`}>
