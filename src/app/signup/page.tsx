    ...
    <div className="relative w-full max-w-md space-y-8">
      ...
      <form onSubmit={handleSignup} className="bg-white/5 border border-white/10 rounded-3xl p-8 space-y-6 backdrop-blur-sm">
        ...
        <div className="bg-[#020420]/50 border border-white/10 rounded-2xl p-6 text-center space-y-2 relative overflow-hidden group">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[#020420] px-2 text-zinc-500 font-medium">Or continue with</span>
              </div>
            </div>
            ...
            <Button
              ...
              className="w-full h-14 bg-white/5 border-white/10 text-white hover:bg-white/10 rounded-xl flex items-center justify-center gap-3 transition-all duration-300"
            >
              {googleLoading ? (
                <Loader2 className="w-5 h-5 animate-spin" />
              ) : (
                <>
                  ...
                  <span className="font-display font-bold tracking-wide">Google</span>
                </>
              )}
            </Button>
          ...
          <Link href={`/login${redirectTo !== '/' ? `?redirectTo=${encodeURIComponent(redirectTo)}` : ''}`} className="text-primary hover:underline underline-offset-4">
            Sign in
          </Link>
        </p>
      </form>
