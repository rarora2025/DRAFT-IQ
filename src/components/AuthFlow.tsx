    ...
    <div className="bg-white/5 border border-white/10 rounded-3xl p-8 space-y-6 backdrop-blur-sm relative overflow-hidden">
      ...
      <div className="space-y-4">
        <Button
          ...
          disabled={loading}
          className="w-full h-12 bg-white text-black hover:bg-white/90 border-none font-medium flex items-center justify-center gap-3 transition-all duration-200"
        >
          {loading ? (
        ...
        <div className="relative flex items-center gap-4 text-xs font-medium uppercase tracking-widest text-zinc-500 py-2">
