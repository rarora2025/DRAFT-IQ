...
export function Navbar() {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#0a0a0f] border-t border-[#27272a]">
        <div className="max-w-lg mx-auto px-4">
          <div className="flex items-center justify-between py-2">
            ...
            <button
              ...
              className="flex flex-col items-center py-2 px-4 text-zinc-500 hover:text-red-400 transition-colors"
            >
        ...
        {showLogoutConfirm && (
          ...
          >
            <motion.div
              ...
              className="bg-[#111116] border border-[#27272a] rounded-2xl p-6 max-w-sm w-full"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-display font-bold text-lg">Confirm Logout</h3>
                <button
                  onClick={() => setShowLogoutConfirm(false)}
