      ...
      >
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="flex flex-col items-center text-center mb-10">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-primary/70 flex items-center justify-center mb-6 shadow-lg shadow-primary/20 ring-4 ring-primary/10">
                <Zap className="w-8 h-8 text-black fill-black/20" />
              </div>
              ...
              <p className="text-zinc-500 font-medium uppercase tracking-widest text-[10px]">Master the art of live projection trading</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              <Button 
                onClick={closeRules}
                className="w-full max-w-sm h-14 bg-primary hover:bg-primary/90 text-black font-display font-black text-lg rounded-2xl shadow-xl shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98] group tracking-tight"
              >
                START TRADING NOW
