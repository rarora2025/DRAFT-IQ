                        ...
                        >
                          ...
                          >
                                <Button
                                  ...
                                  className={`h-10 sm:h-11 w-full sm:w-auto px-8 sm:px-10 rounded-2xl ${isMarketLocked ? 'bg-gray-500/20 text-gray-500 cursor-not-allowed border border-gray-500/30' : (isSellLocked ? 'bg-gray-500/40 text-gray-400 cursor-not-allowed' : 'bg-[#f8564e] hover:bg-[#e04a43] text-white shadow-lg shadow-red-500/20')} font-black uppercase text-xs flex items-center justify-center gap-2`}
                                >
