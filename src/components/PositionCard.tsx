                    ...
                    >
                      ...
                      >
                            <Button
                              ...
                              className={`h-10 sm:h-11 w-full sm:w-auto px-8 sm:px-10 rounded-2xl ${isMarketLocked || (isSellLocked && status === 'idle') ? 'bg-gray-500/20 text-gray-500 grayscale opacity-60 cursor-not-allowed' : 'bg-[#f8564e] hover:bg-[#e04a43] text-white shadow-lg shadow-red-500/20'} font-black uppercase text-xs transition-all`}
                            >
